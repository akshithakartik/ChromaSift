...
**Processes** and **Materials** associated with each pre-processed abstract were extracted using Open AI's GPT-3.5 Turbo and prompt engineering. These processes and materials were used as nodes for the Neo4j database to visualize corresponding relationships with documents. From the scientific abstracts scraped, 7000 nodes and 11,300 relationships were formed. Here is a subset of the resulting Neo4j database:
